...
const RUBRO_CATEGORY_MAP = {
  ...
  ABERTURAS: 'electricidad-y-ferreteria',
  CLAVOS: 'electricidad-y-ferreteria',
  CORREA: 'electricidad-y-ferreteria',
  'DISCO DE CORTE': 'electricidad-y-ferreteria',
  HOGAR: 'electricidad-y-ferreteria',
  MADERA: 'electricidad-y-ferreteria',
  MEDIASOMBRA: 'electricidad-y-ferreteria',
  PINTURA: 'electricidad-y-ferreteria',
  SILICONA: 'electricidad-y-ferreteria',
  VIDRIO: 'electricidad-y-ferreteria',
}
